...
<template>
    <a :href="href"
        ...
        <div class="relative overflow-hidden">
            <NuxtImg :alt="imageAlt" loading="lazy" width="400" height="240" decoding="async"
                class="w-full h-48 sm:h-56 object-cover transition-transform duration-300 group-hover:scale-105"
                :src="imageUrl" style="color: transparent;" v-slot="{ src, isLoaded, imgAttrs }">
        ...
        <div class="p-6 pt-0">
            <p class="text-muted-foreground leading-relaxed line-clamp-3 mb-4">{{ excerpt }}</p><a :href="href"
