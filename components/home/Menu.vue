...
<template>
  ...
  >
    <div class="p-1 bg-[#99999970] dark:bg-[#00000070] rounded-full">
      <div
    ...
    <div
      class="space-y-4 flex items-center justify-center flex-col bg-[#99999970] dark:bg-[#00000070] p-3 rounded-full"
    >
