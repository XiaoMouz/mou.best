...
<template>
  <section
    class="min-h-screen pt-32 pb-20 px-4 max-w-7xl mx-auto animate-fade-in space-y-32"
  >
    <!-- Header -->
    <div class="text-center mb-16">
      ...
      <p
        class="text-xl text-on-surface-variant max-w-2xl mx-auto flex items-center justify-center gap-2"
      >
    ...
    <!-- <div class="space-y-8">
      ...
      >
        <span class="w-8 h-1 bg-primary rounded-full"></span> Special
        Connections
      </h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-6">
        ...
        <FriendsGamingBuddy
          ...
          :history="[
            ...
            },
            {
              ...
              icon: Trophy,
              image:
                'https://images.unsplash.com/photo-1511882150382-421056c8d32e?q=80&w=1600&auto=format&fit=crop',
            },
            {
              year: '2020',
              event: 'Moved to TFT',
            ...
            },
            {
              ...
              icon: Swords,
              image:
                'https://images.unsplash.com/photo-1614680376593-902f74cf0d41?q=80&w=1600&auto=format&fit=crop',
            },
          ]"
        />
          ...
          :history="[
            {
              ...
              icon: Map,
              image:
                'https://images.unsplash.com/photo-1587573089734-09cb69c0f2b4?q=80&w=1600&auto=format&fit=crop',
            },
            {
              year: '2019',
              event: 'The End Dragon',
              icon: Skull,
              image:
            ...
            },
            {
              ...
              icon: Users,
              image:
                'https://images.unsplash.com/photo-1605901309584-818e25960b8f?q=80&w=1600&auto=format&fit=crop',
            },
          ]"
        />
        ...
        <FriendsGamingBuddy
          ...
          :history="[
            ...
            {
              year: '2022',
              event: 'GDQ Appearance',
              icon: Flag,
              image:
                'https://images.unsplash.com/photo-1531297461136-82lw8a1b6c86?q=80&w=1600&auto=format&fit=crop',
            },
            {
              year: '2024',
              event: 'World Record',
              icon: Trophy,
              image:
                'https://images.unsplash.com/photo-1520697517317-6767553cc51a?q=80&w=1600&auto=format&fit=crop',
            },
          ]"
        />
      </div>
