...
<template>
  <ClientOnly>
    <div class="text-xl text-muted-foreground md:text-2xl">
      ...
      <div
        class="inline overflow-hidden px-1"
        :class="{ 'animate-background-blink': isIdle }"
        aria-hidden="true"
      >
        {{ content }}
      </div>
      <div
        class="inline-block w-2 text-2xl md:text-3xl font-bold text-blue-400 rounded-sm select-none"
